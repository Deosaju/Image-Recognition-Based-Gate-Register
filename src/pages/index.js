...
const App = () => {
  ...
  async function process() {
    try {
      const response = await fetch('https://a173-2409-4073-4e99-a76d-ed92-3f32-ab2f-3cb5.ngrok-free.app/capture', {
        method: 'POST', 
        headers: {
  ...
  async function validateImage(){
    try {
      ...
      const response = await fetch('https://a173-2409-4073-4e99-a76d-ed92-3f32-ab2f-3cb5.ngrok-free.app/validate', {
        method: 'POST', 
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    try {
      ...
      for(let i=0; i<responseData.length; i++){
        if(responseData[i].id === LicenseNumber[0].value){
          ...
          const response = await fetch('https://a173-2409-4073-4e99-a76d-ed92-3f32-ab2f-3cb5.ngrok-free.app/face', {
            method: 'POST', 
            headers: {
              'Content-Type': 'application/json'
            },
